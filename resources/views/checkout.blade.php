...
@section('contenido')
            ...
            <div class="grid md:grid-cols-[1.2fr_1fr] gap-5">
               ...
               <form action="{{ route('api_checkout') }}" id="comprar_entrada" method="post" class="w-full">
                  ...
                  <div class="mt-5 flex items-center justify-start gap-x-6">
                     <button type="submit" class="md:w-auto w-full btn btn-primary rounded-lg">Reservar plaza</button>
                  </div>
               </form>
   ...
   @else
      <div class="w-full h-full flex items-center justify-center p-5">
         <div class="caja max-w-xl space-y-7 text-center">
            <div class="my-10">
               <img src="/media/logo.png" class="text-center mx-auto w-20" alt="">
            </div>
